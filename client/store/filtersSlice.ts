...
const filtersSlice = createSlice({
  ...
  initialState,
  reducers: {
    setCompleted(state, action: PayloadAction<CompletedFilter>) { state.completed = action.payload; },
    setPriority(state, action: PayloadAction<PriorityFilter>) { state.priority = action.payload; },
    setDateRange(state, action: PayloadAction<{ gte?: string; lte?: string }>) { state.dateGte = action.payload.gte; state.dateLte = action.payload.lte; },
    setSort(state, action: PayloadAction<SortKey>) { state.sort = action.payload; },
    ...
    setViewMode(state, action: PayloadAction<ViewMode>) { state.viewMode = action.payload; state.page = 1; },
...
export const { setCompleted, setPriority, setDateRange, setSort, setOrder, setSearch, setViewMode, setPage, setLimit, resetFilters } = filtersSlice.actions;
